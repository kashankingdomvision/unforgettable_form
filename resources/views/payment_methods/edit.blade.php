...
<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      <li>
        <a href="{{ route('setting.payment_methods.index') }}" class="btn btn-primary btn-xs"><span class="fa fa-plus">View All Payment Method</span></a>
      </li>
    </ol>
  </section>
              ...
              <div class="form-group">
                ...
                <label for="inputEmail3" class="">Name <span style="color:red">*</span></label>
                  <div class="input-group">
                      ...
                      {!! Form::text('name',$payment_method->name,['class'=>'form-control','placeholder'=>'Name','required'=>'true']) !!}
                  </div>
