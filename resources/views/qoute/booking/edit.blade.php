                            ...
                            <div class="qoute">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2" style="margin-bottom: 15px;">
                                        <label for="inputEmail3" class="">Booking Currency Conversion</label>
                                        <label class="currency"></label>  
                                        <input type="text" class="base-currency"  name="qoute_base_currency[]"  value="{{ $quote_detail->actual_cost != 0 ? number_format($quote_detail->qoute_base_currency, 2, '.', '') : '0.00' }}" readonly><br>
                                    </div>
