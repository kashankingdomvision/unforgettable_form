            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                @foreach ($quotes as $key => $quote)
                    <tr>
                        ...
                        <a onclick="return confirm('Are you sure you want to convert this Quotation to Booking?');" href="{{ route('convert-quote-to-booking', $quote->id) }}" class="btn btn-primary btn-xs" data-title="Delete" data-target="#delete"><span class="fa fa-check"></span></a>
