@extends('content_layout.default')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        View All Booking Method
        <!-- <small>advanced tables</small> -->
      </h1>
      <ol class="breadcrumb">
        <li>
          <a href="{{ route('creat-booking-method') }}" class="btn btn-primary btn-xs" data-title="Add" data-target="#Add"><span class="fa fa-plus">Add</span></a>
        </li>
      </ol>
    </section>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                      ...
                      <a onclick="return confirm('Are you sure want to delete this record ?');" href="{{ route('del-booking-method',$booking_methods->id ) }}" class="btn btn-danger btn-xs" data-title="Delete" data-target="#edit"><span class="fa fa-trash"></span></a>
                  </td>
                  {{-- <td>
