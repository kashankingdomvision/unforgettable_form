...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>View All Templates (Quote)</h1>
        <ol class="breadcrumb">
            <li>
              <a href="{{ route('template.create') }}" class="btn btn-primary btn-xs"><span class="fa fa-plus">Create Template</span></a>
            </li>
          </ol>
    </section>
        ...
        <div class="box">
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>{{ $temp->getUser->name??NULL }}</td>
                  <td>{{ $temp->title }}</td>
                  <td>{{ $temp->getSeason->name }}</td>
                  {{-- <td>{!! $temp->formated_status !!}</td> --}}
                  <td>
