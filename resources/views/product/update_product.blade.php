      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            {!! Form::open(array('route' => array('update-product',$data->id),'method'=>'POST')) !!}
                ...
                <div class="form-group">
                  ...
                  <span style="color:red">*</span>
                    ...
                    <div class="input-group">
                       ...
                       {!! Form::text('code',$data->code,['class'=>'form-control','placeholder'=>'Product Code','required'=>'true']) !!}
                    </div>
                ...
                <div class="form-group">
                  ...
                  <span style="color:red">*</span>
                    ...
                    <div class="input-group">
                       <span class="input-group-addon"><i class="fa fa-user"></i></span>
                       <!-- <input name="username" type="email" class="form-control" placeholder="Username"> -->
                       {!! Form::text('name',$data->name,['class'=>'form-control','placeholder'=>'Product Name','required'=>'true']) !!}
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <span style="color:red">*</span>
                      ...
                      <div class="input-group">
                         <span class="input-group-addon"><i class="fa fa-user"></i></span>
                         <!-- <input name="username" type="email" class="form-control" placeholder="Username"> -->
                         {!! Form::textarea('description',$data->description,['class'=>'form-control','placeholder'=>'Product Name','required'=>'true','rows'=>'4']) !!}
                      </div>
                      <div class="alert-danger" style="text-align:center">{{$errors->first('name')}}</div>
                    </div>
                  </div>
