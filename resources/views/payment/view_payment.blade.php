@extends('content_layout.default')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li>
          <a href="{{ URL::to('creat-payment')}}" class="btn btn-primary btn-xs" ><span class="fa fa-plus">Add</span></a> 
        </li>
      </ol>
    </section>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a onclick="return confirm('Are you sure want to this');" href="{{ URL::to('del-payment/'.$value->id)}}" class="btn btn-primary btn-xs" ><span class="fa fa-remove"></span></a>
                  </td>
                </tr>
