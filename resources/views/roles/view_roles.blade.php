              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a onclick="return confirm('Are you sure want to Delete {{ $value->name }}');" href="{{ URL::to('del-role/'.$value->id)}}" class="btn btn-danger btn-xs" data-title="Delete" data-target="#edit"><span class="fa fa-trash"></span></a>
                  </td>
                </tr>
                @endforeach
                </tbody>
