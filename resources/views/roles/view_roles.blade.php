@extends('content_layout.default')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li>
          <a href="{{ URL::to('add-role')}}" class="btn btn-primary btn-xs" data-title="Add" data-target="#Add"><span class="fa fa-plus">Add</span></a>
        </li>
      </ol>
    </section>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a onclick="return confirm('Are you sure want to Delete {{ $value->name }}');" href="{{ URL::to('del-role/'.$value->id)}}" class="btn btn-primary btn-xs" data-title="Delete" data-target="#edit"><span class="fa fa-remove"></span></a>
                  </td>
                </tr>
                @endforeach
                </tbody>
