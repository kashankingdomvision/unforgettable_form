                        ...
                        <div class="row mt-2">
                            ...
                            <div class="row">
                                <div class="col-md-5 col-sm-offset-1 mb-2">
                                    ...
                                    <label class="radio-inline"><input type="radio" name="rate_type" value="live_rate" {{ $qoute->rate_type == 'live_rate' ? 'checked' : '' }} disabled>Live Rate</label>
                                    <label class="radio-inline"><input type="radio" name="rate_type" value="manual_rate" {{ $qoute->rate_type == 'manual_rate' ? 'checked' : '' }} disabled>Manual Rate</label>
                                </div>
                            </div>
