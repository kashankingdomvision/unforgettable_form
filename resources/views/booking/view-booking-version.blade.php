                    ...
                    <form action="{{ route('creat-quote') }}" method="POST" class="form-horizontal" id="user_form">
                        ...
                        <div class="row">
                            ...
                            <div class="row mt-2">
                                <div class="col-md-5 col-sm-offset-1 mb-2">
                                    ...
                                    <label class="radio-inline"><input type="radio" name="rate_type" value="live_rate" {{ $booking_log->rate_type == 'live_rate' ? 'checked' : '' }} disabled>Live Rate</label>
                                    <label class="radio-inline"><input type="radio" name="rate_type" value="manual_rate" {{ $booking_log->rate_type == 'manual_rate' ? 'checked' : '' }} disabled>Manual Rate</label>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-5 mb-2">
                                ...
                                <input type="text" name="bedding_preferences" value="{{ $booking_log->bedding_preference }}" class="form-control" disabled>
                       ...
                       <div class="row" style="margin-left: 4px;">
                           <div class="col-sm-offset-1 mb-2" id="appendPaxName">
                               @if($booking_log->group_no > 1)
                                   @foreach ($booking_log->getBookingPaxDetailLog as $paxKey => $pax )
                                   @php
                                        $count = $paxKey +1;
                                   @endphp
                                   <div class="mb-2">
