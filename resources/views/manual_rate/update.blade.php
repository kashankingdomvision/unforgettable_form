      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            {!! Form::open(array('route' => array('update-manual-rate',$currency_record->id),'method'=>'POST')) !!}
            <input type="hidden" name="id" value="<?=$currency_record->id;?>">
            ...
            <!-- <form class="form-horizontal"> -->
                <div class="box-body">
                    <div class="box-header with-border mb-2">
                        <h3 class="box-title">Manual Rate Form</h3>
                    </div>
