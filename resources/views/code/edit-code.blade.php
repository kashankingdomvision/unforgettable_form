  ...
  <section class="content">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-info">
          <div class="box-header with-border"><h3 class="box-title">Edit Code</h3></div>
          ...
          <form action="{{ route('update-code',$code->id) }}" class='form-horizontal' method="POST" id='user_form' novalidate>
            @method('PUT')
            <div class="box-body">
              <div class="row">
                @csrf
                <div class="col-sm-5 col-sm-offset-1">
                  ...
                  <div class="input-group">
                    {!! Form::text('ref_no', $code->ref_no,['class'=>'form-control','placeholder'=>'Enter Reference Number','value'=> $code->ref_no ]) !!}
                ...
                <div class="col-sm-5" style="margin-bottom:15px">
                    ...
                    <select class="form-control dropdown_value" name="brand_name">
                        <option value="">Select Brand</option>
                        @foreach($get_user_branches->branches as $branche)
                        <option value="{{ $branche->name }}" {{ !empty($code->brand_name) && $code->brand_name == $branche->name ? 'selected' : '' }}> {{ $branche->name }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-sm-5 col-sm-offset-1" style="margin-bottom:15px;">
                  ...
                  <select class="form-control dropdown_value" id="type_of_holidays" name="type_of_holidays">
                    <option value="">Select Holiday</option>
                    @foreach($get_holiday_type->holiday_type as $holiday)
                    <option value="{{ $holiday->name }}"
                      {{ !empty($code->type_of_holidays) && $code->type_of_holidays == $holiday->name ? 'selected' : '' }}>
                      {{ $holiday->name }}</option>
                    @endforeach
                  </select>
                ...
                <div class="col-sm-5" style="margin-bottom:15px;">
                  ...
                  <select class="form-control select2" id="sales_person" name="sale_person">
                    ...
                    <option value="{{ $user->email }}"
                      {{ !empty($code->sale_person) && $code->sale_person == $user->email  ? 'selected' : '' }}>
                      {{ $user->email }}</option>
                    @endforeach
                  </select>
                ...
                <div class="col-sm-5 col-sm-offset-1" style="margin-bottom:15px">
                  ...
                  <select class="form-control select2 dropdown_value" id="category" name="category">
                    ...
                    <option value="{{ $category->id }}"
                      {{ !empty($code->category) && $code->category == $category->id  ? 'selected' : '' }}>
                ...
                <div class="col-sm-5">
                  ...
                  <select class="form-control select2 dropdown_value" id="product" name="product">
                    <option value="">Select Product</option>
                    @foreach($products as $product)

                    <option value="{{ $product->id }}"
                      {{ !empty($code->product) && $code->product == $product->id  ? 'selected' : '' }}>
              ...
              <div class="col-sm-5 col-sm-offset-1" style="margin-bottom:15px; padding-left:0px;">
                ...
                <select class="form-control dropdown_value" name="season_id">
                  ...
                  <option value="{{ $sess->id }}"
                    {{ !empty($code->season_id) && $code->season_id == $sess->id ? 'selected' : '' }}>{{ $sess->name }}
                  </option>
                  @endforeach
                </select>
              ...
              <div class="col-sm-5" style="margin-bottom: 35px;">
                ...
                {!! Form::radio('agency_booking', 2, !empty($code->agency_booking) && $code->agency_booking == 2 ?
                'checked' : null,['id' => 'ab_yes','required' => 'true']) !!}&nbsp<label for="ab_yes">Yes</label>
                {!! Form::radio('agency_booking', 1,!empty($code->agency_booking) && $code->agency_booking == 1 ?
                'checked' : null ,['id' => 'ab_no','required' => 'true']) !!}&nbsp<label for="ab_no">No</label>
              ...
              <div class="col-sm-5 col-sm-offset-1" style="padding-left:0px;">
                ...
                <select class="form-control dropdown_value select2" name="pax_no" id="pax_no">
                  @for($i=1;$i<=30;$i++) <option value={{$i}}
                    {{ !empty($code->pax_no) && $code->pax_no == $i ? 'selected' : '' }}>{{$i}}</option>
                    @endfor
                </select>
              ...
              <div class="col-sm-5" style="margin-bottom: 15px;">
                ...
                <div class="input-group">
                  ...
                  {!! Form::text('date_of_travel',$code->date_of_travel,['autocomplete' =>
                  'off','class'=>'form-control','id'=>'datepicker','placeholder'=>'Departure Date','required'=>'true'])
                  !!}
                </div>
              ...
              <div class="col-sm-5 col-sm-offset-1" style="padding-left: 0px;">
                ...
                <div class="input-group">
                  <span class="input-group-addon"></span>
                  {!! Form::text('destination',$code->destination,['autocomplete'
                  =>'off','class'=>'form-control','id'=>'destination','placeholder'=>'Destination']) !!}
                </div>
              ...
              <div class="col-sm-5" style="margin-bottom:15px">
                ...
                <select class="form-control select2 dropdown_value" id="supplier" name="supplier">
                  <option value="">Select Supplier</option>
                  @foreach($suppliers as $supplier)
                  <option value="{{ $supplier->id }}" {{ !empty($code->supplier) && $code->supplier == $supplier->id  ? 'selected' : '' }}> {{ $supplier->name }}</option>
                  @endforeach
                </select>
                <div class="alert-danger" style="text-align:center">{{$errors->first('brand_name')}}</div>
              </div>
        ...
        <div class="col-sm-12 up-box" id="flight-booked" style="margin-bottom:10px;margin-top:30px" hidden>
          ...
          <div class="row box-cus">
            <div class="col-sm-4">
              ...
              {!! Form::radio('flight_booked', 'yes', $code->flight_booked == "yes" ? "checked" : null ,['id' =>
              'fb_yes']) !!}&nbsp<label for="fb_yes">Yes</label>
              {!! Form::radio('flight_booked', 'no', $code->flight_booked == "no" ? "checked" : null ,['id' => 'fb_no'])
              !!}&nbsp<label for="fb_no">No</label>
              {!! Form::radio('flight_booked', 'NA', $code->flight_booked == "NA" ? "checked" : null ,['id' => 'fb_NA'])
              !!}&nbsp<label for="fb_NA">NA</label>
            ...
            <div class="col-sm-4 fb_depend">
              ...
              <select class="form-control responsible_person" name="fb_person">
                ...
                <option value="{{ $person->id }}"
                  {{ !empty($code->fb_person) && $code->fb_person == $person->id  ? 'selected' : '' }}>
                  {{ $person->name }}
                </option>
                @endif
                @endif
            ...
            <div class="col-sm-4 fb_depend">
              ...
              <div class="input-group">
                <span class="input-group-addon"></span>
                {!! Form::text('fb_last_date',$code->fb_last_date,['autocomplete'
                =>'off','class'=>'form-control','id'=>'datepicker3','placeholder'=>'Last Date Of Flight Booking']) !!}
              </div>
            ...
            <div class="col-sm-4" style="margin-bottom:15px">
              <div class="fb_airline_name_id" style="display: none;">
                ...
                <select class="form-control select2" name="fb_airline_name_id">
                  ...
                  <option value="{{ $user->id }}" {{ !empty($code->fb_airline_name_id) && $code->fb_airline_name_id == $user->id  ? 'selected' : '' }}> {{ $user->name }}</option>
                  @endforeach
                </select>
              ...
              <div class="fb_payment_method_id" style="display: none;">
                ...
                <select class="form-control select2" name="fb_payment_method_id">
                  ...
                  <option value="{{ $user->id }}"
                    {{ !empty($code->fb_payment_method_id) && $code->fb_payment_method_id == $user->id  ? 'selected' : '' }}>
                    {{ $user->name }}</option>
                  @endforeach
                </select>
            ...
            <div class="col-sm-4" style="margin-bottom:15px">
              <div class="fb_booking_date" style="display: none;">
                ...
                <div class="input-group">
                  <span class="input-group-addon"></span>
                  {!! Form::text('fb_booking_date',$code->fb_booking_date,['autocomplete'=>'off','class'=>'form-control','id'=>'datepicker14','placeholder'=>'Booking Date']) !!}
                </div>
            ...
            <div class="col-sm-3" style="margin-bottom: 15px">
              <div class="fb_airline_ref_no" style="display: none;">
                ...
                <div class="input-group">
                  <span class="input-group-addon"></span>
                  {!! Form::text('fb_airline_ref_no',$code->fb_airline_ref_no,['autocomplete'
                  =>'off','class'=>'form-control','id'=>'','placeholder'=>'Airline Ref No']) !!}
                </div>
            ...
            <div class="col-sm-10 col-sm-offset-1">
              <div class="flight_booking_details" style="display: none;">
                ...
                <div class="input-group">
                  <span class="input-group-addon"></span>
                  {!!
                  Form::textarea('flight_booking_details',$code->flight_booking_details,['class'=>'form-control','placeholder'=>'Flight Booking Detail','style'=>'height: 60px;width: 450px']) !!}
                </div>
        ...
        <div class="col-sm-12 up-box" id="transfer-info" hidden>
          ...
          <div class="row box-cus">
            ...
            <div class="col-sm-7">
              ...
              <div class="row">
                ...
                <div class="col-sm-3">
                  ...
                  {!! Form::radio('asked_for_transfer_details', 'yes', $code->asked_for_transfer_details == "yes" ? "checked" : null ,['id' => 'td_yes']) !!}&nbsp<label  for="td_yes">Yes</label>
                  {!! Form::radio('asked_for_transfer_details', 'no',$code->asked_for_transfer_details == "no" ? "checked" : null,['id' => 'td_no']) !!}&nbsp<label for="td_no">No</label>
                  {!! Form::radio('asked_for_transfer_details', 'NA',$code->asked_for_transfer_details == "NA" ? "checked" : null,['id' => 'td_NA']) !!}&nbsp<label for="td_NA">NA</label>
                  <div class="alert-danger" style="text-align:center">{{$errors->first('asked_for_transfer_details')}}
                  </div>
                  {{-- new fields add here --}}
                </div>
                ...
                <div class="col-sm-4 aft_depend">
                  ...
                  <select class="form-control responsible_person_depend" name="aft_person">
                    ...
                    @if($person->id != 1)
                    <option value="{{ $person->id }}"
                      {{ !empty($code->aft_person) && $code->aft_person == $person->id  ? 'selected' : '' }}>
                      {{ $person->name }}</option>
                    @endif
                    @endif
                    @endforeach
                ...
                <div class="col-sm-5 aft_depend">
                  ...
                  <div class="input-group">
                    <span class="input-group-addon"></span>
                    {!! Form::text('aft_last_date',$code->aft_last_date,['autocomplete' => 'off','class'=>'form-control','id'=>'datepicker10','placeholder'=>'Last Date','required'=>'true']) !!}
                  </div>
              ...
              <div class="transfer_details" style="margin-bottom:25px;display: none;">
                ...
                <div class="input-group">
                  <span class="input-group-addon"></span>
                  {!! Form::textarea('transfer_details',$code->transfer_details,['class'=>'form-control','placeholder'=>'Asked For Transfer
                  Details','style'=>'height:60px']) !!}
                </div>
            ...
            <div class="col-sm-5 col-sm-offset-1">
              ...
              <div class="input-group">
                <span class="input-group-addon"></span>
                {!! Form::text('form_sent_on',$code->form_sent_on,['autocomplete' =>
                'off','class'=>'form-control','id'=>'datepicker2','placeholder'=>'Form Sent On','required'=>'true']) !!}
              </div>
          ...
          <div class="col-sm-5 fso_depend">
            ...
            <div class="input-group">
              <span class="input-group-addon"></span>
              {!! Form::text('fso_last_date',null,['autocomplete' =>
              'off','class'=>'form-control','id'=>'datepicker15','placeholder'=>'Date']) !!}
            </div>
      ...
      <div class="row box-cus">
        <div class="row">
          <div class="col-sm-3">
            ...
            {!! Form::radio('transfer_organised', 'yes',$code->transfer_organised == "yes" ? "checked" : null,['id' => 'tro_yes']) !!}&nbsp<label for="tro_yes">Yes</label>
            {!! Form::radio('transfer_organised', 'no',$code->transfer_organised == "no" ? "checked" : null,['id' => 'tro_no'])!!}&nbsp<label for="tro_no">No</label>
            {!! Form::radio('transfer_organised', 'NA',$code->transfer_organised == "NA" ? "checked" : null,['id' => 'tro_NA'])!!}&nbsp<label for="tro_NA">NA</label>
          ...
          <div class="col-sm-4 to_depend">
            ...
            <select class="form-control responsible_person_depend" name="to_person">
              ...
              @if($person->id != 1)
              <option value="{{ $person->id }}"
                {{ !empty($code->to_person) && $code->to_person == $person->id  ? 'selected' : '' }}>{{ $person->name }}
              </option>
              @endif
              @endif
              @endforeach
          ...
          <div class="col-sm-5 to_depend">
            ...
            <div class="input-group">
              <span class="input-group-addon"></span>
              {!! Form::text('to_last_date',$code->to_last_date,['autocomplete' =>'off','class'=>'form-control','id'=>'datepicker6','placeholder'=>'Last Date Of Transfer Organised','required'=> 'true']) !!}
            </div>
          ...
          <div class="transfer_organised_details col-sm-12" style="display: none;">
            ...
            <div class="input-group">
              <span class="input-group-addon"></span>
              {!! Form::textarea('transfer_organised_details',
              $code->transfer_organised_details,['class'=>'form-control','placeholder'=>'Transfer Organised
              Details','style'=>'height:60px']) !!}
            </div>
      ...
      <div class="row box-cus">
        ...
        <div class="row">
          <div class="col-sm-3">
            ...
            {!! Form::radio('itinerary_finalised', 'yes',$code->itinerary_finalised == "yes" ? "checked" : null,['id' =>
            'itf_yes']) !!}&nbsp<label for="itf_yes">Yes</label>
            {!! Form::radio('itinerary_finalised', 'no',$code->itinerary_finalised == "no" ? "checked" : null,['id' =>
            'itf_no']) !!}&nbsp<label for="itf_no">No</label>
            {!! Form::radio('itinerary_finalised', 'NA',$code->itinerary_finalised == "NA" ? "checked" : null,['id' =>
            'itf_NA']) !!}&nbsp<label for="itf_NA">NA</label>
          ...
          <div class="col-sm-4 itf_depend">
            ...
            <select class="form-control responsible_person_depend" name="itf_person">
              ...
              @if($person->id != 1)
              <option value="{{ $person->id }}"
                {{ !empty($code->itf_person) && $code->itf_person == $person->id  ? 'selected' : '' }}>
                {{ $person->name }}
              </option>
              @endif
              @endif
          ...
          <div class="col-sm-5 itf_depend">
            ...
            <div class="input-group">
              <span class="input-group-addon"></span>
              {!! Form::text('itf_last_date',$code->itf_last_date,['autocomplete' =>
              'off','class'=>'form-control','id'=>'datepicker9','placeholder'=>'Last Date Of Itinerary
              Finalised','required'
              => 'true']) !!}
            </div>
          ...
          <div class="itinerary_finalised_details col-sm-9" style="display: none;">
            ...
            <div class="input-group">
              <span class="input-group-addon"></span>
              {!! Form::textarea('itinerary_finalised_details',
              $code->itinerary_finalised_details,['class'=>'form-control','placeholder'=>'Itinerary Finalised
              Details','style'=>'height:60px']) !!}
            </div>
          ...
          <div class="col-sm-5 itf_current_date" style="display: none;">
            ...
            <div class="input-group">
              <span class="input-group-addon"></span>
              {!! Form::text('itf_current_date',null,['autocomplete' =>
              'off','class'=>'form-control','id'=>'datepicker17','placeholder'=>'Itinerary Finalised Date','required' =>
              'true']) !!}
            </div>
      ...
      <div class="row box-cus">
        <div class="row">
          <div class="col-sm-3">
            ...
            {!! Form::radio('document_prepare', 'yes',$code->document_prepare == "yes" ? "checked" : null,['id' =>
            'dp_yes']) !!}&nbsp<label for="dp_yes">Yes</label>
            {!! Form::radio('document_prepare', 'no',$code->document_prepare == "no" ? "checked" : null,['id' =>
            'dp_no'])
            !!}&nbsp<label for="dp_no">No</label>
            {!! Form::radio('document_prepare', 'NA',$code->document_prepare == "NA" ? "checked" : null,['id' =>
            'dp_NA'])
            !!}&nbsp<label for="dp_NA">NA</label>
          ...
          <div class="col-sm-4 dp_depend">
            ...
            <select class="form-control responsible_person_depend" name="dp_person">
              ...
              @if($person->id != 1)
              <option value="{{ $person->id }}"
                {{ !empty($code->dp_person) && $code->dp_person == $person->id  ? 'selected' : '' }}>{{ $person->name }}
              </option>
              @endif
              @endif
              @endforeach
          ...
          <div class="col-sm-5 dp_depend">
            ...
            <div class="input-group">
              <span class="input-group-addon"></span>
              {!! Form::text('dp_last_date',$code->dp_last_date,['autocomplete' =>
              'off','class'=>'form-control','id'=>'datepicker7','placeholder'=>'Last Date Of Document Prepared']) !!}
          ...
          <div class="col-sm-5 tdp_current_date">
            <div class="tdp_current_date" style="display: none;">
              ...
              <div class="input-group">
                <span class="input-group-addon"></span>
                {!! Form::text('tdp_current_date',$code->tdp_current_date,['autocomplete' =>
                'off','class'=>'form-control','id'=>'datepicker18','placeholder'=>'Travel Document Prepared Date']) !!}
              </div>
    ...
    <div class="col-sm-10 col-sm-offset-1">
      ...
      <div class="col-md-12 finance-holiday-amount text-center">
        ...
        <input id="holiday" type="text" name="holiday" value="{{ $code->holiday }}">
      </div>

      <div class="deposit-remaining">
        <div class="col-sm-12">
          <label>Deposit Received
            <input type='checkbox' id="deposit" name="deposit_received"  value="1"  style="margin:5px" {{ $code->deposit_received == "1" ? "checked" : ''  }}/>
          </label>
          <div class="alert-danger" style="text-align:center">{{$errors->first('deposit_received')}}</div>

          <label>Remaining Amount Received
            <input type='checkbox' id="remain" name="remaining_amount_received" value="1" style="margin:5px"  {{ $code->remaining_amount_received == "1" ? "checked" : ''  }}/>
          </label>
    ...
    <div class="col-sm-10 col-sm-offset-3" style="margin-top: 15px;">
      <div class="col-sm-4">
        <a data-id="travel-document-sent" class="btn btn-primary down-btn">Travel Document +</a>
      </div>
      <div class="col-sm-4">
      ...
      <div class="row box-cus">
        ...
        <div class="row">
          ...
          <div class="col-sm-3">
            ...
            {!! Form::radio('documents_sent', 'yes',$code->documents_sent == "yes" ? "checked" : null,['id' =>
            'ds_yes'])
            !!}&nbsp<label for="ds_yes">Yes</label>
            {!! Form::radio('documents_sent', 'no',$code->documents_sent == "no" ? "checked" : null,['id' => 'ds_no'])
            !!}&nbsp<label for="ds_no">No</label>
            {!! Form::radio('documents_sent', 'NA',$code->documents_sent == "NA" ? "checked" : null,['id' => 'ds_NA'])
            !!}&nbsp<label for="ds_NA">NA</label>
          ...
          <div class="col-sm-4 ds_depend">
            ...
            <select class="form-control responsible_person_depend" name="ds_person">
              ...
              @if($person->id != 1)
              <option value="{{ $person->id }}"
                {{ !empty($code->ds_person) && $code->ds_person == $person->id  ? 'selected' : '' }}>{{ $person->name }}
              </option>
              @endif
              @endif
              @endforeach
          ...
          <div class="col-sm-5 ds_depend">
            ...
            <div class="input-group">
              <span class="input-group-addon"></span>
              {!! Form::text('ds_last_date',$code->ds_last_date,['autocomplete' =>
              'off','class'=>'form-control','id'=>'datepicker5','placeholder'=>'Last Date Of Document
              Sent','required'=>'true']) !!}
            </div>
        ...
        <div class="documents_sent_details" style="display: none;">
          ...
          <div class="input-group">
            <span class="input-group-addon"></span>
            {!! Form::textarea('documents_sent_details',$code->documents_sent_details,['class'=>'form-control','placeholder'=>'Document
            Details','style'=>'height:60px']) !!}
          </div>
        ...
        <div class="col-sm-5 tds_current_date">
          ...
          <div class="input-group">
            <span class="input-group-addon"></span>
            {!! Form::text('tds_current_date', $code->tds_current_date == "yes" ? "checked" : null ,['autocomplete' =>'off','class'=>'form-control','id'=>'datepicker19','placeholder'=>'Travel Document Sent Date','required' => 'true']) !!}
          </div>
    ...
    <div class="col-sm-12 down-box" id="app-login-sent" style="margin-bottom: 10px" hidden>
      ...
      <div class="row box-cus">
        ...
        {!! Form::radio('electronic_copy_sent', 'yes',$code->electronic_copy_sent == "yes" ? "checked" : null,['id' => 'ecs_yes']) !!}&nbsp<label for="ecs_yes">Yes</label>
        {!! Form::radio('electronic_copy_sent', 'no',$code->electronic_copy_sent == "no" ? "checked" : null,['id' => 'ecs_no']) !!}&nbsp<label for="ecs_no">No</label>
        ...
        <div class="row set_reminder_app">
          ...
          <div class="col-sm-4 aps_depend">
            ...
            <select class="form-control responsible_person_depend" name="aps_person">
              ...
              @if($person->id != 1)
              <option value="{{ $person->id }}"
                {{ !empty($code->aps_person) && $code->aps_person == $person->id  ? 'selected' : '' }}>
                {{ $person->name }}
              </option>
              @endif
              @endif
          ...
          <div class="col-sm-5 aps_depend">
            ...
            <div class="input-group">
              <span class="input-group-addon"></span>
              {!! Form::text('aps_last_date',$code->aps_last_date,['autocomplete' =>'off','class'=>'form-control','id'=>'datepicker16','placeholder'=>'Date']) !!}
            </div>
        ...
        <div class="electronic_copy_details" style="display: none;">
          ...
          <div class="input-group">
            <span class="input-group-addon"></span>
            {!! Form::textarea('electronic_copy_details',$code->electronic_copy_details,['class'=>'form-control','placeholder'=>'App Login Sent Details','style'=>'height:60px']) !!}
          </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        function doneTyping () {
          console.log('done-typing');
            ...
            $('#form_received').html('');
            $('#app_tab').html('<tr class="odd"><td valign="top" colspan="8" class="dataTables_empty">No data available in table</td></tr>');
                    ...
                    success:function(data) {
                        if(data.item_rec4 != null){
                            ...
                            for (i = 0; i < data.item_rec4.record.length; ++i) {
                                ...
                                $conversion = data.item_rec4.record[i].conversion;
                                $tab = $tab + $new;
                                $('#datepicker').val(data.item_rec4.record[i].depart);
                                $('#holiday').val(data.item_rec4.holiday_amount * $conversion);
                                $('#type_of_holidays').val(data.item_rec4.record[i].holiday_type);
                                $('#sales_person').val(data.item_rec4.record[i].sales_person);
                                $('#select2-sales_person-container').attr('title',data.item_rec4.record[i].sales_person);
                                $('#select2-sales_person-container').html(data.item_rec4.record[i].sales_person);
                                $('#pax_no').val(data.item_rec4.record[i].pax);
                                $('#select2-pax_no-container').attr('title',data.item_rec4.record[i].pax);
                                $('#select2-pax_no-container').html(data.item_rec4.record[i].pax);
                                data.item_rec4.record[i].client_type == 2 ? $('#ab_yes').prop('checked',true) : $('#ab_no').prop('checked',true);
                                data.item_rec4.record[i].paid == 1 ? $('#remain').prop('checked',true) : '';
                                data.item_rec4.record[i].payment_method == 3 ? $('#deposit').prop('checked',true) : '';
                        ...
                        if(data.item_rec2 != null){
                          if("id" in data.item_rec2){
                            ...
                            $('#link').html('<small><a href="https://unforgettabletravelcompany.com/ufg-form/user/'+id+'" target="_blank">View Reference Detail</a></small>');
    ...
    $(document).ready(function() {
        $('input:radio[name=flight_booked]:checked').trigger('click');
        $('input:radio[name=asked_for_transfer_details]:checked').trigger('click');
        $('input:radio[name=transfer_info_received]:checked').trigger('click');
        $('input:radio[name=itinerary_finalised]:checked').trigger('click');
        $('input:radio[name=documents_sent]:checked').trigger('click');
        $('input:radio[name=electronic_copy_sent]:checked').trigger('click');
        $('input:radio[name=transfer_organised]:checked').trigger('click');
        $('input:radio[name=document_prepare]:checked').trigger('click');
    });
    ...
    $('#category , #product').on('change', function(){
        ...
        $.ajax({
            ...
            success: function(response){
                init = '<option value="">Select Supplier</option>';
                if(response.length == 0){
                    add = '<option value="">No Record Found</option>';
                    init = init + add;
                }
                var i;
                for(i = 0;i < response.length;i++){
                    add = "<option value='"+response[i].supplier+"'>"+response[i].name+"</option>";
                    init = init + add;
                }
                $('#supplier').html('');
                $('#supplier').html(init);
