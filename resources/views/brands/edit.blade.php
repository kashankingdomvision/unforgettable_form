                  ...
                  <div class="box-body">
                    <div class="form-group">
                        <div class="col-sm-6 col-sm-offset-3 " >
                            ...
                            <input type="text" name="name" class="form-control" placeholder="Enter the brand name" value="{{ old('name')??$brand->name }}" id="brandName" />
                    ...
                    <div class="form-group">
                        <div class="col-sm-6 col-sm-offset-3 " >
                            ...
                            <input type="email" name="email" class="form-control" placeholder="Enter the email address" value="{{ old('email')??$brand->email }}" id="brandEmail" />
                    ...
                    <div class="form-group">
                        <div class="col-sm-6 col-sm-offset-3 " >
                            ...
                            <input type="text" name="address" class="form-control" placeholder="Enter the brand address" value="{{ old('address')??$brand->address }}" id="brandAddress" />
                    ...
                    <div class="form-group">
                        <div class="col-sm-6 col-sm-offset-3 " >
                            ...
                            <input type="Number" name="phone" class="form-control" placeholder="Enter the phone number (03062122433)" value="{{ old('phone')??$brand->phone }}" id="brandPhone" />
