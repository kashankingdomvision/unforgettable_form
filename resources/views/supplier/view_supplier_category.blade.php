          ...
          <div class="box">
            ...
            <div class="box-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tr>
                        <td>{{ $supplier_category->supplier_id }}</td>
                        <td>{{ $supplier_category->supplier_name }}</td>
                        <td>{{ $supplier_category->category_name }}</td>
                        {{-- <td>{{ $supplier_product->supplier_name }}</td>
                        <td>{{ $supplier_product->code }}</td>
                        <td>{{ $supplier_product->name }}</td>
                        <td>{{ $supplier_product->description }}</td> --}}
                    </tr>
                    @endforeach
                    </tbody>
                </table>
