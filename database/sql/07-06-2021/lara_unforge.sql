...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 07, 2021 at 04:48 PM
...
CREATE TABLE `finance_booking_details` (
  ...
  `upload_calender` varchar(10) DEFAULT NULL,
...
(1, 'zoho', 'uc20181999', '60be30f0ac68a', 'Dinning Preferences', 'Test passenger nameas', 'Unforgettable Travel', 'UCroatia: Activity Holiday', 'muntahaismat@gmail.com', 1, 1, NULL, NULL, 'EUR', NULL, 1, 2.56, 0.00, 2.56, 0.00, 0, 0.00, 0.00, NULL, NULL, 0, '2021-06-07 09:46:06', '2021-06-07 09:46:30');
...
(2, 1, NULL, NULL, NULL, NULL, NULL, '2021-06-02', 1, 1, NULL, NULL, NULL, 'AUD', 0.00, 0.00, NULL, 0, 0.00, '2021-06-07 09:46:30', '2021-06-07 09:46:30'),
(3, 1, NULL, NULL, NULL, NULL, NULL, '2021-06-23', 1, 1, NULL, NULL, NULL, 'AUD', 4.00, 0.00, NULL, 0, 2.56, '2021-06-07 09:46:30', '2021-06-07 09:46:30');
...
INSERT INTO `qoute_detail_logs` (`id`, `qoute_id`, `date_of_service`, `service_details`, `category_id`, `supplier`, `booking_date`, `booking_due_date`, `booking_method`, `booked_by`, `booking_refrence`, `booking_type`, `comments`, `supplier_currency`, `cost`, `supervisor_id`, `added_in_sage`, `qoute_base_currency`, `log_no`, `created_at`, `updated_at`) VALUES
(1, 1, NULL, NULL, NULL, NULL, NULL, '2021-06-02', 1, 1, NULL, NULL, NULL, 'AUD', 0.00, NULL, 0, 0.00, 1, '2021-06-07 09:46:30', '2021-06-07 09:46:30');
...
INSERT INTO `qoute_logs` (`id`, `reference_name`, `qoute_id`, `ref_no`, `quotation_no`, `dinning_preferences`, `lead_passenger_name`, `brand_name`, `type_of_holidays`, `sale_person`, `season_id`, `agency_booking`, `agency_name`, `agency_contact_no`, `currency`, `convert_currency`, `group_no`, `net_price`, `markup_amount`, `selling`, `gross_profit`, `markup_percent`, `show_convert_currency`, `per_person`, `port_tax`, `total_per_person`, `is_email_send`, `log_no`, `created_date`, `user_id`, `created_at`, `updated_at`) VALUES
(1, 'zoho', 1, 'uc20181999', '60be30f0ac68a', 'Dinning Preferences', 'Test passenger nameas', 'Unforgettable Travel', 'UCroatia: Activity Holiday', 'muntahaismat@gmail.com', 1, 1, NULL, NULL, 'EUR', NULL, 1, 0.00, 0.00, 0.00, NULL, 0, 0.00, 0.00, NULL, NULL, 0, 1, '2021-06-07', 1, '2021-06-07 09:46:30', '2021-06-07 09:46:30');
...
(1, 'Muhammad.Kashan', 'irfan@kingdom-vision.co.uk', 2147483647, 2, '2021-05-28', '2021-03-30'),
(2, 'Raza', 'abc@gmail.com', 2147483643, 3, '2021-03-30', '2021-03-30'),
(4, 'Kashan Mehmood', 'sn@kingdom-vision.co.uk', 2147483647, 3, '2021-03-31', '2021-03-31'),
...
(1, '\r\nAdmin', 'kashan.kingdomvision@gmail.com', 1, NULL, NULL, '$2y$10$PZvdq9E3SrPjGlPM22bxf.FZA57s4Id8LxRUQin0O3rYgOoHP9RiC', NULL, 0, NULL, NULL, '2021-06-07 11:27:04', '2021-06-07 11:27:04'),
(6, 'ashah', 'ashas@gmail.com', 2, NULL, 7, '$2y$10$P.GHMdVGk.Y0lSFHqUeFSOrV/.44iuTkSwg5ENmMhld8A3JDXlbBe', NULL, 0, 3, 'Unforgettable Greece', '2021-06-07 08:06:55', '2021-06-07 08:15:30');
...
(1, '1000.f07c6e03fa956656371a7226d6ebd576.78a5a1af693f0f2b6d389b8fe11633c4', '1000.39110e76491f89f7384569c1f40905da.492a266f5842fe86d8c2bed2a73a76df', '1000.93747e52d8c3bb5611666cf01cbd3e84.3c185f593775e82635f3c52d22bcf5cf');
